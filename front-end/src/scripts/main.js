...
function getWeatherIcon(condition) {
	const icons = {
		Sunny: 'src/assets/icons/sunny.gif',
		Rain: 'src/assets/icons/rain.gif',
		Cloudy: 'src/assets/icons/cloudy.gif',
		Snow: 'src/assets/icons/snow.gif'
	}
	return icons[condition] || 'src/assets/icons/sunny.gif'
}
